...
It’s a nice excuse to talk about the role of the weak form &mdash; especially compatibility and equilibrium conditions &mdash; and to show that the so-called energy theorems follow directly from choosing suitable test functions in the weak formulation.
...
```{admonition} Example: evaluation of hyperstatics
:class: tip
